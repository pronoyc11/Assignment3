...
CREATE TABLE Users (
  ...
  role varchar(30) DEFAULT 'Football Fan' NOT NULL,
...
--Query 4: Retrieve match booking details along
--with the User's full name and the scheduled Match fixture teams.
SELECT
  b.booking_id,
  u.full_name,
  m.fixture,
...
--Query 6: Find all ticket bookings 
--where the total cost is strictly higher than the average cost of all ticket bookings.
SELECT
  booking_id,
  match_id,
  total_cost
